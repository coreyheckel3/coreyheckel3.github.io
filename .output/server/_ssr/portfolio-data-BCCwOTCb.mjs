//#region node_modules/.nitro/vite/services/ssr/assets/portfolio-data-BCCwOTCb.js
var CONTACT = {
	name: "Corey Heckel",
...
var EXPERIENCE = [
	{
		...
		bullets: [
			"Developed and deployed multiple production recommendation models from 0 to 1, driving a 23.7% increase in Add-to-Cart rate, 13.3% lift in average order value, and $133M in annualized incremental demand.",
	...
	},
	{
		...
		sites: [
			{
				label: "Vesper NYC",
				url: "https://vespernyc.com"
			},
			{
				label: "Paraiso NYC",
				url: "https://paraisonyc.com"
			},
			{
				label: "Riva Sunset",
				url: "https://rivasunset.com"
			},
			{
				label: "Pied Piper Productions",
				url: "https://piedpiperproductions.com"
			},
			{
				label: "Downtown Bar Fest",
				url: "https://downtownbarfest.com"
			},
			{
				label: "My House Como",
				url: "https://myhousecomo.com"
			},
			{
				label: "Mirari Presents",
				url: "https://miraripresents.com"
			},
			{
				label: "Palma Day Club",
				url: "https://palmadayclub.com"
			},
			{
				label: "Azure Day Party",
				url: "https://azuredayparty.com"
			},
			{
				label: "Above Ten",
				url: "https://aboveten.com"
			}
		]
	},
	{
		...
		bullets: ["Developed an augmented reality system in C# that empowers blind users to write using audio feedback, achieving 90% handwriting recognition accuracy.", "Enhanced handwriting accuracy by 30% by targeting faults in handwriting attempts identified by CNNs."],
		tech: [
			"C#",
			"Unity",
			"Augmented Reality",
	...
	},
	{
		...
		bullets: ["Conducted a case study of 800+ participants analyzing how dashboard visuals affect strategic decision making — simplistic visuals increased decision speed by 15% and task completion by 5%.", "Optimized an artillery dashboard for the Department of Defense using insights from the case study."],
		tech: [
			"Dashboards",
			"Data Visualization",
			"User Research",
	...
	},
	{
		...
		bullets: ["Analyzed high-speed motion capture data to evaluate joint movement and biomechanical inefficiencies, contributing to a 15% reduction in deceleration injury risk.", "Developed MATLAB scripts to process kinematic data and optimize pitching mechanics, improving velocity, accuracy, and efficiency by up to 10%."],
		tech: [
			"MATLAB",
			"Motion Capture",
			"Biomechanics",
	...
	},
	{
		...
		bullets: ["Assisted the professor with tool installation and setup, assignment grading, and student inquiries."],
		tech: [
			"Java",
			"Maven",
			"GitHub",
...
var PROJECTS = [
	{
		...
		details: "SonicScript is an AR system built in C# and Unity that lets blind users write in the air and receive real-time audio guidance. A CNN-based handwriting recognizer reaches 90% accuracy, and a fault-targeting feedback loop identifies specific stroke errors — improving handwriting accuracy by an additional 30% over the baseline model."
	},
	{
		...
		details: "Used NLP techniques to accurately classify toxic comments. The team engineered and compared RNNs using GloVe, BERT, GRUs, and LSTMs — each leveraging different ML concepts — to predict whether a comment includes toxic language or is acceptable for online presence."
	},
	{
		...
		details: "Focused on data cleaning and feature engineering, then trained and evaluated Linear Regression, Random Forest, and CatBoost. CatBoost delivered the strongest performance, demonstrating ML's potential for accurate, data-driven real estate pricing."
	},
	{
		...
		details: "Stacked Logistic Regression, Decision Trees, Random Forest, Gradient Boosting, and SVMs to predict company bankruptcy. The model iterates through kFold values 3–10 and combinations of base learners, selecting the best fit by lowest bias² and variance, with accuracy as the tiebreaker."
	},
	{
		...
		details: "Trained and tuned classification models in R and Python to detect fraudulent credit card transactions. The work was scoped to statistical methods from the Statistics With Applications in Finance course, achieving very high precision and recall on imbalanced data via SMOTE."
	},
	{
		slug: "arpu-forecast",
		...
		details: "Aggregated and cleaned unstructured financial and economic data from multiple sources to build a custom dataset, then trained, tested, and compared linear regression, polynomial regression, and ARIMA time-series models to produce a high-accuracy, generalized forecast."
	},
	{
		slug: "echolab",
		name: "EchoLab",
		...
		details: "EchoLab lets users collaboratively code in rooms with voice chat. User and room data are stored in MongoDB; code outputs are cached in Redis. Live updates are synchronized via Socket.IO. Submitted code runs in Docker images, and the platform is deployed on AWS Lambda."
	},
	{
		slug: "course-review",
		...
		details: "Enables users to search university courses and leave reviews. All user, university, and course data lives in MongoDB. Built with Node, Express, and Handlebars, with jQuery for async data fetching. The team practiced agile with weekly sprints."
	},
	{
		slug: "gedcom",
		name: "GEDCOM Parser",
		...
		details: "Developed in Python to extract and analyze GEDCOM data. Ran weekly sprints with backlog, burndown, and velocity tracked in Excel. Built unit tests to validate every extraction against user stories."
	},
	{
		slug: "irwin",
		...
		details: "Comprehensive survey system letting users create, edit, take, and analyze surveys. Built on the MERN stack with Auth0 for authentication. Owners can cleanly export responses to Excel for further analysis."
	},
	{
		...
		details: "Interactive visualization for exploring changes to the electoral voting system. Users can allocate votes from each district to a preferred candidate instead of winner-take-all by state, and import 2016/2020 results to see how outcomes would shift."
	},
	{
		...
		details: "Independently developed in Phaser, Node, and Express. Players make daily decisions — studying, napping, dining, the gym — that affect health, hunger, sanity, and grades. Successful runs end with graduation."
	},
	{
		slug: "theres-options",
		...
		details: "Assists beginner traders with impactful decisions by surfacing top-performing stocks, market news, and notable investor positions. Domain filters let users compare stocks across sectors. UI designed in Figma; team ran weekly agile sprints."
	},
	{
		slug: "arduino-robot",
		...
		details: "Assembled and programmed a robot with a WeMos board and ultrasonic sensors to navigate to a series of locations while avoiding obstacles. Chassis modeled in SolidWorks to mount hardware components."
	},
	{
		...
		details: "Used a WeMos board and weather kit to collect humidity, light intensity, and temperature data over time. Sent the data to an IoT server and visualized it via LabVIEW dashboards."
	}
];
var PUBLICATIONS = [{
	...
	summary: "Peer-reviewed study evaluating ChatGPT's ability to generate correct, idiomatic Python across a range of prompt styles and task difficulties."
}];
//#endregion
export { PUBLICATIONS as a, PROJECTS as i, EDUCATION as n, SKILL_CATEGORIES as o, EXPERIENCE as r, CONTACT as t };
