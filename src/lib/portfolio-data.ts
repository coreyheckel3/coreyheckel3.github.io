export const CONTACT = {
  ...
  resume: "/Corey_Heckel_Resume.pdf",
};
...
export const SKILL_CATEGORIES: SkillCategory[] = [
  ...
  },
  {
    ...
    blurb:
      "Classical ML, deep learning, and applied generative AI in production.",
    skills: [
...
export const PROJECTS: Project[] = [
  {
    ...
    period: "2026",
    category: "ML",
    metric: "End-to-end ML control plane",
    tech: [
      "Python",
      "FastAPI",
      "React",
    ...
    summary:
      "Production-style ML platform for datasets, feature pipelines, experiments, model registry, deployment, monitoring, drift detection, and retraining.",
    details:
      "ForgeML is a modular ML platform control plane built with production boundaries from the start: FastAPI services, SQLAlchemy/Alembic persistence, RBAC, dataset and feature-store workflows, experiment tracking, model registry promotion, deployment releases, inference monitoring, drift detection, and automatic retraining. The React/Vite console includes operational workflows, release evidence, admin controls, observability surfaces, Docker Compose infrastructure, and CI-checked readiness contracts.",
  },
  {
    slug: "reelrank",
    name: "ReelRank",
    ...
    summary:
      "Conversational movie recommender with real ranking models, strict offline evaluation, and a grounded agentic AI layer.",
    details:
      "ReelRank trains and serves a recommender stack on MovieLens data, combining a PyTorch two-tower model, metadata retrieval, sequence-aware scoring, and GRU4Rec ablations. A LangGraph agent parses user intent, asks clarifying questions, calls explicit recommender tools, reranks grounded catalog candidates, and explains results without inventing movies. The larger local demo covers 3,883 movies, 6,040 users, and 1,000,209 ratings, reaching 0.213 Recall@10 and a 3.38x lift over the best simple item-item baseline.",
  },
  {
    slug: "nil-platform",
    name: "NIL Platform",
    ...
    period: "2026",
    category: "Web",
    metric: "Basketball value intelligence",
    tech: [
      "Next.js",
      "React",
      "TypeScript",
    ...
    summary:
      "Premium NIL analytics platform for college basketball players, schools, and brands.",
    details:
      "NIL Platform is a premium basketball value-intelligence product powered by Play Value Score and Market Value Score. It includes athlete discovery, saved shortlists, media kits, contracts, compliance checks, deal-room workflows, campaigns, trust and payout review surfaces, Stripe-backed plans, Supabase-backed data access, ESPN women's college basketball stat sync, and role-aware AI coaches for athletes, brands, and compliance workflows.",
  },
  {
    slug: "sonicscript",
    name: "SonicScript",
    ...
    summary:
      "Augmented reality writing system that empowers blind users to write with real-time audio feedback.",
    details:
  ...
  },
  {
    ...
    summary:
      "Private relationship app with a scrapbook, songs, notes, map pins, daily questions, and shared memory tools.",
    details:
      "Built4Two is a passcode-protected private app for two people to collect memories in one shared space. It combines a horizontal photo timeline, love notes, shared bucket list, Leaflet-powered memory map, daily question archive, mood board, music-library imports, sync-state APIs, profile-aware sessions, PWA icons, and an offline shell into a polished private product experience.",
  },
  {
    ...
    summary:
      "Engineered and compared RNN, GRU, LSTM, and BERT models to classify online comments as toxic or acceptable.",
    details:
  ...
  },
  {
    ...
    summary:
      "Team project estimating house prices on a 3,000-sample Kaggle dataset — CatBoost delivered the best performance.",
    details:
  ...
  },
  {
    ...
    summary:
      "Stacked ensemble predicting bankrupt companies with 98% accuracy on financial data.",
    details:
  ...
  },
  {
    ...
    summary:
      "Logistic regression and tree-based classifiers detecting fraudulent credit card transactions.",
    details:
  ...
  },
  {
    ...
    summary:
      "Forecasted ARPU and economic trends for African countries through 2035 to study the digital divide.",
    details:
  ...
  },
  {
    ...
    summary:
      "Collaborative coding platform with voice chat, real-time rooms, and Docker-sandboxed code execution.",
    details:
  ...
  },
  {
    ...
    summary:
      "Course search and review platform built with the Node/Express/Handlebars stack.",
    details:
  ...
  },
  {
    ...
    summary:
      "Python tool to analyze and extract genealogical data from GEDCOM datasets.",
    details:
  ...
  },
  {
    ...
    summary:
      "MERN-stack web survey system supporting authoring, taking, and analyzing surveys.",
    details:
  ...
  },
  {
    ...
    summary:
      "Interactive map that lets users reallocate electoral votes by district to explore reform scenarios.",
    details:
  ...
  },
  {
    ...
    summary:
      "Stevens-themed reimagining of Jones In The Fast Lane — graduate while juggling health, hunger, sanity, and grades.",
    details:
  ...
  },
  {
    ...
    summary:
      "React app helping beginner traders explore top stocks, market news, and notable investor positions.",
    details:
  ...
  },
  {
    ...
    summary:
      "Autonomous robot navigating an arena while avoiding obstacles, with a custom SolidWorks chassis.",
    details:
  ...
  },
  {
    ...
    summary:
      "Collected humidity, light, and temperature data and streamed it to an IoT server with LabVIEW dashboards.",
    details:
