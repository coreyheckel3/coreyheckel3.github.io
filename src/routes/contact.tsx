  ...
  head: () => ({
    meta: [
      { title: "Contact — Corey Heckel" },
      {
        name: "description",
        content:
          "Reach out to Corey Heckel for freelance web development, AI/ML features, or general inquiries.",
      },
      ...
      <div className="grid md:grid-cols-12 gap-12">
        <div className="md:col-span-5">
          ...
          <p className="mt-5 text-lg text-muted-foreground">
            ...
            AI/ML features, and rescue projects. I usually reply within 48
            hours.
          </p>
          ...
          <dl className="mt-10 space-y-5 text-sm">
            ...
            <Field label="LinkedIn">
              <a
                ...
                className="hover:text-ember"
              >
                linkedin.com/in/corey-heckel ↗
              </a>
            </Field>
            <Field label="Résumé">
              <a href={CONTACT.resume} className="hover:text-ember">
                Download PDF ↓
              </a>
            </Field>
          </dl>
